...
{
    public class CategoriesMultiSelectPresenter : Presenter<ICategoriesMultiSelectView>
    {
        private readonly ICategoryService categoryService;

        public CategoriesMultiSelectPresenter(ICategoriesMultiSelectView view, ICategoryService categoryService) : base(view)
        {
